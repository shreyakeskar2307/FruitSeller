...
<body>
    ...
    <h1 class="mb-4">Inventory Manage</h1>
    <div class="row g-4">
        ...
        <div class="col-md-3">
            <a href="all_product.php" style="text-decoration: none;">
                <div class="manager-card clients-manager">
                    <i class="bi bi-people-fill"></i> All Product
                </div>
            </a>
        </div>
        ...
        <div class="col-md-3">
            <a href="up_product.php" style="text-decoration: none;">
                <div class="manager-card inventory-manager">
                    <i class="bi bi-pencil-square"></i> Update/Delete Product
                </div>
            </a>
        </div>
