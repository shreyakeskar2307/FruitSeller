...
<body>
    ...
    <h1 class="mb-4">Manage Client and Coupon</h1>
    <div class="row g-4">
        <!-- New Registration -->
        <div class="col-md-3">
        ...
        <div class="col-md-3">
            <a href="register_client.php" style="text-decoration: none;">
                <div class="manager-card clients-manager">
                    <i class="bi bi-people-fill"></i> View Registered Clients
                </div>
            </a>
        </div>
        ...
        <div class="col-md-3">
            <a href="admin_client.php" style="text-decoration: none;">
                <div class="manager-card inventory-manager">
                    <i class="bi bi-pencil-square"></i> View Admin Clients
                </div>
            </a>
        </div>
        ...
        <div class="col-md-3">
            <a href="coupon.php" style="text-decoration: none;">
                <div class="manager-card sales-master">
                    <i class="bi bi-ticket-detailed-fill"></i> Coupon List
                </div>
            </a>
        </div>
        ...
        <!-- Customer Enquiry -->
        <div class="col-md-3">
            <a href="contact_details.php" style="text-decoration: none;">
                <div class="manager-card inventory-manager">
                    <i class="bi bi-chat-dots-fill"></i> Customer Enquiry
                </div>
            </a>
        </div>
    </div>
