...
$db = new class_functions();
 ...
 if (isset($_GET['excel_export'])) {
    ...
    $reg_data = $db->get_admin_client_report(); // Ensure this function fetches data correctly
    $show_column = false;
...
<div class="main-container">
    ...
    <div class="table-container">
        <h1 style="font-weight:bold;color: #28a745; text-align: center;">Admin Client Report</h1>
    ...
    <tbody>
        <?php
        $reg_data = array();
        $reg_data = $db->get_admin_client_report();
        ...
        if(!empty($reg_data))
        {
            ...
            foreach($reg_data as $record)//read all data from start to end
            {
                ...
                <td><?php echo $counter+1;      ?></td>
                    ...
                    <td>
                    <!-- <td><?php echo $res_admin_image;    ?></td> -->
                    <img src="/shreyaPHP/fruit seller/Admin/admin_image/<?php echo $res_admin_image; ?>" alt="Admin Image" width="80" height="80">
                    </td>
...
<td>
    <a href="admin_client.php?delete_id=<?php echo $res_id; ?>" 
       class="delete-btn" 
