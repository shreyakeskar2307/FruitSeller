...
if (isset($_GET['excel_export'])) {
    ...
    $reg_data = $db->get_user_report_product_fruit();
    $show_column = false;
...
<div class="content">
    ...
    <?php
        $reg_data = array();
        $reg_data = $db->get_user_report_product_dryfruit();
    ...
    <div class="card-body">
        ...
        <h4 class="card-text color">Rs <?php echo $res_offer_price; ?></h4>
