...
//  }
 ...
 if(isset($_GET['delete_id']))
 {
    ...
    //DELETE RECORD
    $db->delete_register_client_record($del_id);
 }
 if (isset($_GET['excel_export'])) {
    ...
    $reg_data = $db->get_register_client_report(); // Ensure this function fetches data correctly
    $show_column = false;
...
<html lang="en">
    ...
    <title>Register client report</title>
...
<div class="main-container">
    ...
    <div class="table-container">
        <h1 style="font-weight:bold;color: #28a745; text-align: center;">Register Client Report</h1>
    ...
    <tbody>
        <?php
        $reg_data = array();
        $reg_data = $db->get_register_client_report();
        ...
        if(!empty($reg_data))
        {
            ...
            foreach($reg_data as $record)//read all data from start to end
            {
                ...
                <tr>
                    ...
                    <!-- <td><?php echo $res_profile_image;    ?></td> -->
                    <td>
    <img src="/shreyaPHP/fruit seller/profile_image/<?php echo $res_profile_image; ?>" alt="Admin Image" width="80" height="80">
</td>
...
<td>
    <a href="register_client.php?delete_id=<?php echo $res_id; ?>" 
       class="delete-btn" 
